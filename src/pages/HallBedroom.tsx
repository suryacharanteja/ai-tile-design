...
const HallBedroom = () => {
  ...
  } = useRoomVisualization('hall-bedroom');
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="font-medium">Hall & Bedroom</span>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Hall & Bedroom Tile Visualizer
          </h1>
          <p className="text-lg text-muted-foreground">
            Upload your room image and apply premium tiles to see how they'll look
          </p>
        </div>

        {!uploadedImage ? (
          <div className="max-w-2xl mx-auto">
            <ImageUploader id="hall-bedroom-uploader" onFileSelect={handleImageUpload} imageUrl={uploadedImage} />
          </div>
        ) : (
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-card rounded-lg p-6 border">
                <h3 className="text-lg font-semibold mb-4">Select Tiles</h3>
